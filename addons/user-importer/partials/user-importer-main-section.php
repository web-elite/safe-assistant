<div class="wrap">
    <h1><?php esc_html_e('User Importer', 'safe-assistant'); ?></h1>

    <!-- Import Panel -->
    <div id="aui-panel-import" class="aui-panel">
        <div class="postbox">
            <div class="inside">
        ...
        <form method="post" enctype="multipart/form-data" class="postbox">
            <div class="inside">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const panels = document.querySelectorAll('.aui-panel');

        function activateTab(tabKey) {
            panels.forEach(panel => panel.style.display = 'none');
            document.getElementById(`aui-panel-${tabKey}`).style.display = 'block';
            tabs.forEach(tab => {
                tab.classList.remove('nav-tab-active');
                if (tab.dataset.tab === tabKey) tab.classList.add('nav-tab-active');
            });
        }
