=== Safe Assistant ===
Contributors: https://wordpress.com/reader/users/aliyaghouti
...
- release 1.6.7
- feat: admin can customize text for free shipping
- release 1.6.8
- Merge branch 'master' of https://github.com/web-elite/safe-asisstant
- update translate
- release 1.6.9
- fix nirwallet expire hour check
- release 1.7.0
- fix: remove welcome page setting framework
- release 1.7.1
- feat: add custom css and js for wp admin and frontend section + translations
- release 1.7.2
...
= 1.5.45 =
fetch update info in second time
